 ...
 * Version:     1.5.6. (modified by Paul van Schayck)
...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateRangeInput(oTable) {
            ...
            var from = $('<input placeholder="0" type="text" class="number_range_filter form-control" id="' + sFromId + '" rel="' + i + '"/>');
            th.append(from);
            th.append(_fnRangeLabelPart(1));
            var sToId = oTable.attr("id") + '_range_to_' + i;
            var to = $('<input placeholder="&infin;" type="text" class="number_range_filter form-control" id="' + sToId + '" rel="' + i + '"/>');
            th.append(to);
