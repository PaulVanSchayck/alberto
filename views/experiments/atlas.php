            ...
            <div class="panel-heading">
                <h3 class="panel-title">
                    ...
                    <span class="btn-group pull-right">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="#" title="gene - 16-cell" class="download-png">PNG</a></li>
                            <li><a href="#" title="gene - 16-cell" class="download-svg">SVG</a></li>
                        </ul>
                    </span>
                </h3>
            </div>
    ...
    <div class="col-lg-4">
        <div class="panel panel-default">
            ...
            <div class="panel-body scale">
                <b class="badge">0</b>
                <input type="text" class="scale-slider form-control" name="scale" data-slider-min="0" data-slider-max="200" data-slider-step="1" data-slider-value="[8,75]" data-plugin-name="slider" title="slider">
                <b class="badge">150</b>
                <div class='checkbox'>
        ...
        <div class="panel-body">
            ...
            <table class="display" id="<?=$experimentName?>-table">
                ...
                <tr class="topHeader">
                    ...
                    <th colspan="8">16 Cell stage</th>
                    <th colspan="16">Early globular stage</th>
                    <th colspan="19">Late globular stage</th>
                    <th colspan="31">Fold changes</th>
                </tr>
                <tr class="headers">
                    <th>AGI</th>
                    <th>Gene</th>
