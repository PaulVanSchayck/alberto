...
<div class="site-index">
    ...
    <ul class="nav nav-tabs experiments" role="tablist">
        <li class="active" data-toggle="tab">
            <a href="#intact" data-toggle="tooltip" data-original-title="Transcriptome of individual cell types">Embryonic cell types</a>
        </li>
        <li>
            <a href="#" data-toggle="tooltip" data-original-title="Transcriptome of MP mutant compared to WT"><i>Monopteros</i> mutants transcriptome</a>
        </li>
        <li class="disabled"><a href="#">Root gradients</a></li>
    </ul>

    <div class="tab-content">
        <div class="tab-pane active" id="intact">
            <div class="row">
                <div class="col-lg-4">
